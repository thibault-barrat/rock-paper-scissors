...
const ImageRules = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 304 270" aria-labelledby='rules' className={styles.rules}>
      <title id="rules">Rock beats scissors, scissors beats paper, paper beats rock</title>
        <defs>
