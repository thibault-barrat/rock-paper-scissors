...
import styles from "./ImageRules.module.scss";
    ...
    <>
      ...
      {isHard && (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 340 330"
          aria-labelledby="rules-bonus"
          className={styles.rules}
        >
          <title id="rules-bonus">
            Rock beats scissors and lizard, lizard beats spock and paper, spock beats scissors and rock, scissors beats paper and lizard, paper beats rock and spock.
          </title>
          <defs>
            <linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%">
